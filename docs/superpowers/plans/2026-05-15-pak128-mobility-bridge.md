...
- [x] **Step 1: Write failing protocol/state tests**
...
- [x] **Step 3: Implement protocol and reducer**
...
- [x] **Step 3: Implement client and overlay**
...
- [x] **Step 1: Write failing E2E expectation**
...
- [x] **Step 3: Wire mobility into `src/main.ts`**
