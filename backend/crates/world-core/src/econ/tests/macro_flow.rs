...
use crate::econ::MarketDistances;
use crate::econ::macro_flow::synthetic_price;
use crate::econ::macro_flow::{
...
use crate::econ::{EconomyError, TRANSPORT_OPERATOR, transport_cost};
...
fn build_macro_buckets_caps_effective_demand_and_supply() {
    ...
    let buckets = build_macro_buckets(
        ...
        &demand,
        &supply,
        &mut crate::econ::InputPools::default(),
        &crate::econ::ProducerPolicies::default(),
        /*capita_factor=*/ 1,
        /*current_tick=*/ 0,
        &mg,
        &dormant,
        &cfg,
        &crate::econ::OrderBook::default(),
        false,
    )
    .unwrap();
...
fn classify_bucket_partitions_matched_surplus_deficit() {
    use crate::econ::macro_flow::classify_bucket;
...
fn sort_candidates_total_order() {
    use crate::econ::macro_flow::sort_candidates;
...
fn plan_flows_consumes_disjoint_budgets_once() {
    use crate::econ::macro_flow::sort_candidates;
    use crate::econ::macro_flow::{PlannedFlow, plan_flows};
...
fn plan_flows_self_and_cross_are_disjoint() {
    use crate::econ::macro_flow::plan_flows;
    use crate::econ::macro_flow::sort_candidates;
...
fn settle_flow_conserves_and_credits_operator_exactly() {
    use crate::econ::macro_flow::PlannedFlow;
    use crate::econ::macro_flow::settle_flow;
    use crate::econ::{TRANSPORT_OPERATOR, TradeLedger};
...
fn settle_flow_n_buyers_aggregate_floor_conserves() {
    use crate::econ::macro_flow::PlannedFlow;
    use crate::econ::macro_flow::settle_flow;
    use crate::econ::{EconomyEvent, TRANSPORT_OPERATOR};
...
use crate::econ::macro_flow::run_macro_flow_at_tick;
use crate::econ::{DirtyMarketGoods, EconomyEvent, TradeLedger};
...
fn macro_flow_only_fires_on_interval() {
    ...
    run_macro_flow_at_tick(
        ...
        &cfg,
        3,
        &mut crate::econ::FlowShipments::default(),
        &mut crate::econ::NextShipmentId::default(),
        &mut crate::econ::RealizedFlows::default(),
        &mut crate::econ::OrderBook::default(),
        &mut crate::econ::NextOrderId::default(),
...
fn macro_flow_settle_fault_isolates_and_conserves() {
    use crate::econ::MarketGoodState;
...
struct DormantScenario {
    ...
    dirty: crate::econ::DirtyMarketGoods,
...
fn surplus_deficit_scenario(
    ...
    DormantScenario {
        ...
        dirty: crate::econ::DirtyMarketGoods::default(),
...
fn macro_flow_threads_orderbook_and_counter_unchanged() {
    ...
    let mut orders = crate::econ::OrderBook::default();
    orders.bids.insert(
        crate::econ::OrderId(7),
        crate::econ::Bid {
            id: crate::econ::OrderId(7),
    ...
    orders.asks.insert(
        crate::econ::OrderId(8),
        crate::econ::Ask {
            id: crate::econ::OrderId(8),
    ...
    let mut next_oid = crate::econ::NextOrderId(42);
    ...
    assert!(
        s.ledger
            .0
            .iter()
            .any(|e| matches!(e, crate::econ::EconomyEvent::MacroFlow { .. })),
...
fn write_back_preserves_active_price_but_updates_traded_and_residual() {
    ...
    crate::econ::macro_flow::write_back(&mut mg, key, Money(999), 5, 3, 2, 7, true).unwrap();
    let s = &mg.0[&key];
    assert_eq!(
    ...
    crate::econ::macro_flow::write_back(&mut mg, key, Money(999), 2, 1, 0, 8, false).unwrap();
    let s = &mg.0[&key];
    assert_eq!(
        s.last_settlement_price,
        Money(999),
...
fn active_flow_conserves_and_drains_residual_orders() {
    ...
    crate::econ::macro_flow::run_macro_flow_at_tick(
        &mut accounts,
        &mut inventory,
        &mut crate::econ::TradeLedger::default(),
        &DemandPools::default(),
        &SupplyPools::default(),
        &mut crate::econ::InputPools::default(),
        &crate::econ::ProducerPolicies::default(),
        /*capita_factor=*/ 1,
        &mut mg,
        &crate::econ::DirtyMarketGoods::default(),
        &BTreeSet::new(),
        &distances,
        &config,
        0,
...
fn active_multi_ask_partial_export_settles_not_faults() {
    ...
    let money_before = accounts.total_money().unwrap();
    let good_before = inventory.total_good(GOOD_FOOD).unwrap();
    let mut ledger = crate::econ::TradeLedger::default();
    ...
    assert!(
        !ledger
            .0
            .iter()
            .any(|e| matches!(e, crate::econ::EconomyEvent::MarketClearFailed { .. })),
...
fn realized_flows_carry_shipped_quantity() {
    ...
    let mut s = surplus_deficit_scenario(1, 200, 500, 1, 200, 2000, 4, Money(50));
    let mut realized = crate::econ::RealizedFlows::default();
    run_macro_flow_at_tick(
        &mut s.accounts,
        &mut s.inventory,
        &mut s.ledger,
...
use crate::econ::producers::{InputPool, InputPools, ProducerPolicies, ProducerPolicy};
use crate::econ::{GOOD_TOOLS, GOOD_WOOD, HOUSEHOLD_SECTOR};
