use crate::econ::apportion_cash;
use crate::econ::prorata_distribute;
use crate::econ::{
...
fn filled_for_bid(plan: &crate::econ::ClearingPlan, id: u64) -> i64 {
    plan.fills
        .iter()
...
fn filled_for_ask(plan: &crate::econ::ClearingPlan, id: u64) -> i64 {
    plan.fills
        .iter()
