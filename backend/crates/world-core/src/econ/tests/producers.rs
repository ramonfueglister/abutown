...
use crate::econ::producers::{participation_bound, run_generate_input_orders_at_tick};
use crate::econ::{
...
fn input_order_sizes_to_batches_target_minus_held() {
    ...
    let config = crate::econ::EconomyConfig::default(); // labor_share_bps=6_000
...
fn input_order_scales_target_by_capita_factor() {
    ...
    let mut policies = ProducerPolicies::default();
    let mut market_goods = MarketGoods::default();
    let config = crate::econ::EconomyConfig::default();
