...
fn regenerate_system_feeds_input_gated_production_same_tick() {
    // PRODUCER_TOOLS has a RAW faucet + a RAW->TOOLS recipe. After one schedule run, the RAW
    ...
    use crate::economy::production::{
        PRODUCER_TOOLS, ProductionPool, ProductionPools, RawDeposit, RawDeposits, Recipe,
    };
