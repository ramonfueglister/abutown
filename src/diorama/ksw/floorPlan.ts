...
export const kswPlan: FloorPlan = {
  ...
  outdoorProps: [
    ...
    { kind: 'tree', x: -26.0, z: -24.5, scale: 1.15 },
    { kind: 'tree', x: -10.0, z: -24.0 },
    { kind: 'tree', x: 6.0, z: -24.8, scale: 1.25 },
    { kind: 'tree', x: 21.0, z: -24.0, scale: 0.95 },
    { kind: 'tree', x: 33.0, z: -14.0 },
    { kind: 'tree', x: 33.4, z: 0.5, scale: 1.2 },
    { kind: 'tree', x: 33.0, z: 13.0, scale: 0.9 },
    { kind: 'tree', x: 20.0, z: 20.0, scale: 1.1 },
    { kind: 'tree', x: 12.5, z: 23.5 },
    { kind: 'tree', x: -12.5, z: 24.0, scale: 1.1 },
