...
import { economySnapshotFromProto, type EconomyVitalsDto, type MarketLocationDto, type MarketGoodDto } from './mobilityProtocol';
...
export function applyEconomyServerMessage(
  ...
  return { tick: dto.tick, markets, goods, vitals: dto.vitals };
}
